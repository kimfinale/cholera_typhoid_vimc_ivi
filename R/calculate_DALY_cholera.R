...
calculate_DALY_cholera <- function (country,
                               cases,
                               year = 2000:2100,
  ...
  YLL <- calculate_YLL_cholera(cases = cases,
   ...
   YLD <- calculate_YLD_cholera(cases = cases,
