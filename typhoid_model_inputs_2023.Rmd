...
template <- 
  fread("inst/extdata/central-burden-template.202310gavi-4.Typhoid_IVI-Kim_standard.csv")
target_countries_tf <- clean_country_names(unique(template$country_name))
usethis::use_data(target_countries_tf, overwrite = T)

vacc_cov_input_campaign_default_tf <- fread("inst/extdata/coverage_202310gavi-4_typhoid-campaign-default.csv")
vacc_cov_input_campaign_routine_default_tf <- fread("inst/extdata/coverage_202310gavi-4_typhoid-campaign-routine-default.csv")
vacc_cov_input_campaign_bluesky_tf <- fread("inst/extdata/coverage_202310gavi-4_typhoid-campaign-bluesky.csv")
vacc_cov_input_campaign_routine_bluesky_tf <- fread("inst/extdata/coverage_202310gavi-4_typhoid-campaign-routine-bluesky.csv")

vacc_cov_input_tf <- list()
vacc_cov_input_tf[[1]] <- vacc_cov_input_campaign_default_tf
vacc_cov_input_tf[[2]] <- vacc_cov_input_campaign_routine_default_tf
vacc_cov_input_tf[[3]] <- vacc_cov_input_campaign_bluesky_tf
vacc_cov_input_tf[[4]] <- vacc_cov_input_campaign_routine_bluesky_tf
usethis::use_data(vacc_cov_input_tf, overwrite = T)

vacc_scenarios_tf <- 
  c("novacc", "campaign_default","campaign_routine_default", "campaign_bluesky",  "campaign_routine_bluesky")
...
# str_dis_disability2 <- c("Disability weight for moderate typhoid fever",
# "Disability weight for severe typhoid fever",
# "Disability weight for severe typhoid fever with gastrointestinal bleeding",
# "Disability weight for severe typhoid fever with abdominal complications (other than gastrointestinal bleeding)")
...
incid_number_tf_ihme <- rbind(incid_number_tf_ihme_2010_2017,
                              incid_number_tf_ihme_2015_2019)
#
incid_number_tf_ihme$location_name <- clean_country_names(incid_number_tf_ihme$location_name) 
...
incid_rate_tf_ihme$location_name <- clean_country_names(incid_rate_tf_ihme$location_name) 
...
incid_tf_ihme$location_name <- 
  clean_country_names(incid_tf_ihme$location_name) 
...
```{r}
countries <- unique(vacc_cov_input_campaign_default_tf$country)
countries <- unique(c(countries, unique(vacc_cov_input_campaign_default_tf$country)))
